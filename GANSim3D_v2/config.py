...
num_gpus = 4; 
train.total_kimg = 600000
dataset.data_range = [0, 2]
#----------------------------------------------------------------------------
# Paths.
data_dir    = '/scratch/users/suihong/SubwaterFan/DatasetsforGAN_freq_3D_128x128x32/'  # Training data path
...
sched.G_lrate_dict             = {4: 0.0025, 8: 0.005, 16: 0.005, 32: 0.0035, 64: 0.0035, 128: 0.0035} #, 64: 0.0025}; 
sched.D_lrate_dict             = EasyDict(sched.G_lrate_dict); 
sched.lod_training_kimg_dict   = {4: 480, 8:480, 16:640, 32:640, 64:960, 128: 960}
sched.lod_transition_kimg_dict = {4: 480, 8:480, 16:640, 32:640, 64:960, 128: 960}
sched.max_minibatch_per_gpu    = {32: 64, 64: 32, 128: 16}
sched.tick_kimg_dict           = {4: 480, 8:480, 16:320, 32:320, 64:320, 128: 60} # {4: 160, 8:160, 16:320, 32:240, 64:80}
